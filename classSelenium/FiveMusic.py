...
# 輸入帳號、密碼
account_input.send_keys("test@gmail.com")
...
#產品修改
select_productPage = driver.find_element(By.XPATH, "")
select_productPage.click()
time.sleep(5)

product_update = driver.find_element(By.XPATH, "")
product_update.click()
time.sleep(5)
